...
void comdb2DropTable(Parse *, SrcList *, int);
...
void comdb2AlterColumnSetAutoIncrement(Parse *);
...
void comdb2AddAutoIncrement(Parse *);
...
void comdb2CreateHashPartition(Parse* p, IdList *, IdList *, int);
