...
partition_options ::= MOD LP idlist(A) RP case_exprlist(Y) END.{
    comdb2CreateModPartition(pParse, A, Y);
}
merge ::= .
merge ::= merge_with.
...
%ifdef SQLITE_BUILDING_FOR_COMDB2
  ...
  GRANT INCLUDE INCREMENT IPU ISC KW LUA LZ4 MANUAL MERGE MOD NONE
