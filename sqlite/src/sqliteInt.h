...
#if defined(SQLITE_BUILDING_FOR_COMDB2) || defined(SQLITE_DEBUG) || defined(SQLITE_HAVE_OS_TRACE)
  void sqlite3DebugPrintf(const char*, ...);
#endif /* defined(SQLITE_BUILDING_FOR_COMDB2) || defined(SQLITE_DEBUG) || defined(SQLITE_HAVE_OS_TRACE) */
#if defined(SQLITE_BUILDING_FOR_COMDB2)
...
#endif
#if defined(SQLITE_BUILDING_FOR_COMDB2)
void sqlite3DropTable(Parse*, SrcList*, int, int, int);
#else
...
#endif
int sqlite3ExprIsInteger(Expr*, int*, Parse*);
...
char* sqlite3ExprDescribeParams(Vdbe *v, const Expr *pExpr, 
      struct params_info **pParamsOut, SrcList *srcs);
